...
class ViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        if cLength > vlength {
            ...
            scrollView.maximumZoomScale = vlength/cLength*2
        } else {
